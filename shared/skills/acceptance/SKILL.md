...
Save to `swarm-report/<slug>-e2e-scenario.md` using the canonical E2E Scenario template from the current runtime's project instructions. Add fields `Project type: <project_type>` and `Spec source: <what was used>` at the head.
